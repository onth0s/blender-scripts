...
def global_keymap():
    ...
    km.keymap_items.new(
        pie, 'C', 'PRESS').properties.name = "PIE_MT_KEY_CONDITIONS"
    km.keymap_items.new(pie, 'S', 'PRESS',
                        ctrl=True).properties.name = "PIE_MT_SAVE_N_STUFF"
    ...
    kmi = km.keymap_items.new("aaa.shift_ctrl_f", 'F',
                              'PRESS', shift=True, ctrl=True)

    kmi = km.keymap_items.new("aaa.shift_alt_z", 'Z',
                              'PRESS', shift=True, alt=True)

    kmi = km.keymap_items.new("aaa.ctrl_f", 'F', 'PRESS', ctrl=True)
    kmi = km.keymap_items.new("aaa.ctrl_alt_h", 'H',
    ...
    kmi = km.keymap_items.new(
        pie, 'D', 'PRESS').properties.name = "VIEW3D_MT_GP_BRUSHES_PIE"
    ...
    km = kc.keymaps.new(
        'Node Generic', space_type='NODE_EDITOR', region_type='WINDOW')
    kmi = km.keymap_items.new(pie, 'SPACE', 'PRESS').properties\
        .name = "PIE_MT_SPACE"
